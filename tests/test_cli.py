...
from psmcp.cli import _get_server_config
...
class TestServeConfig:
    def test_stateless_http_disabled_by_default(self, clean_env):
        ...
        assert stateless_http is False

    def test_stateless_http_enabled_from_env(self, clean_env, monkeypatch):
        ...
        *_, stateless_http = _get_server_config(args)

        assert stateless_http is True

    def test_cli_flag_overrides_env(self, clean_env, monkeypatch):
